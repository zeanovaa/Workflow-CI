...
# ──────────────────────────────────────────────
# 5. MANUAL LOGGING — langsung ke active run MLProject
# Tidak perlu set_experiment() atau start_run()
...
# Ambil run_id dari active run MLProject
...
# Simpan run_id untuk dipakai step berikutnya di CI
